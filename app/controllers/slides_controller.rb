class SlidesController < ApplicationController
  ...
  private
    ...
    def slide_params
      params.require(:slide).permit(:caption, :expires_at, :title, :collection_id, :slide_type_id, :image, :video, :kiosk_ids, date_ranges_attributes: [:id, :start_date, :end_date, :_destroy])
    end
