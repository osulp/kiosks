import {
  ...
  SET_HOURS,
  SET_MAPS,
  FETCHED_CLASSROOM_SCHEDULE,
  FETCHING_CLASSROOM_SCHEDULE,
  SET_CLASSROOM_SCHEDULE,
  FETCHED_CLASSROOMS,
  FETCHING_CLASSROOMS,
  TOGGLE_CLASSROOM_SELECTED,
  FETCHED_TODAYS_HOURS,
  FETCHING_TODAYS_HOURS,
  SET_TODAYS_HOURS
  ...
  switch (action.type) {
    ...
    case SET_CLASSROOM_SCHEDULE:
      return Object.assign({}, state, {
        ...
        classroom_schedule: action.data.classroom_schedule
      })
    case SET_MAPS:
