    ...
    return (
      <div className="navigation-menu">
        <NavButton 
          ...
          className={`nav-button ${selectedButtonClassName(0)}`}
        >Home</NavButton>
        <NavSpacer width="35px" />
        <NavButton 
          aria-label="Map" 
          onClick={props.mapMenuItemClicked}
          className={`nav-button ${selectedButtonClassName(1)}`}
        >Map</NavButton>
        <NavSpacer width="35px" />
        <NavButton 
        ...
        >Libraries &amp; Press Directory</NavButton>
        <NavSpacer width="35px" />
        <NavButton 
        ...
        >Libraries &amp; Press Leadership Directory</NavButton>
        <NavSpacer width="35px" />
        <NavButton 
        ...
        >Ecampus Leadership Directory</NavButton>
      </div>
    )
}
