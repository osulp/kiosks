...
class Kiosk extends Component {
  ...
  mainMenuClicked() {
    trackClicked(
      ...
      `${this.props.kiosk_name}:${
        this.props.kiosk_id
      }:InteractiveKiosk:Header:MainMenu`
    )
  ...
  staticMapsClicked() {
    trackClicked(
      ...
      `${this.props.kiosk_name}:${
        this.props.kiosk_id
      }:InteractiveKiosk:Menu:StaticMaps`
    )
    this.setState({ menuCollapsed: true })
    this.setState({ selectedMenuItem: "maps" })
  ...
  searchPrimoClicked() {
    trackClicked(
      ...
      `${this.props.kiosk_name}:${
        this.props.kiosk_id
      }:InteractiveKiosk:Menu:SearchPrimo`
    )
    this.setState({ menuCollapsed: true })
