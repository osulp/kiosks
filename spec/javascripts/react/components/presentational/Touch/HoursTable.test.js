import HoursTable from '../../../../../../app/assets/javascripts/react/components/presentational/Touch/HoursTable';
...
describe('HoursTable', () => {
  it('has all required props', () => {
    ...
    Object.keys(HoursTable.propTypes).forEach(k => expect(props[k]).toBeDefined());
  });
  it('has a table', () => {
