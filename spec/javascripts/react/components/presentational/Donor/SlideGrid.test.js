...
import SlideGrid from '../../../../../../app/assets/javascripts/react/components/presentational/Donor/SlideGrid';
import {shallow} from 'enzyme';
import * as factories from "../../../.factories";

const setup = () => {
  const new_slide = Object.assign({}, factories.slide, {slide_type: "Our Supporters"});
  const props = {
...
describe('Donor::SlideGrid', () => {
  ...
  it('simulates an onclick for Our Supporters', () => {
    const {enzyme_wrapper, props} = setup();
    enzyme_wrapper.find("button")
                  .findWhere(b => b.prop("data-slidetype") == "Our Supporters")
                  .simulate("click", {target: {dataset: {slide_type:"Our Supporters"}}});
