...
} from "../../../../app/javascript/react/actions/circActions"
import * as actionCreator from "../../../../app/javascript/react/actions/circActions"
...
describe("Action::Circulation", () => {
  describe("#fetchRoomsAvailableCount()", () => {
    ...
    it("should work", () => {
      ...
      const asyncAction = actionCreator.fetchRoomsAvailableCount(
        bogus_rooms_available_count_url,
        test_date
      )
