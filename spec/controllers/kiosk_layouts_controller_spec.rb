...
RSpec.describe KioskLayoutsController, type: :controller do
  ...
  # KioskLayout. As you add validations to KioskLayout, be sure to
  ...
  # KioskLayoutsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "DELETE #destroy" do
    it "destroys the requested kiosk_layout" do
      kiosk_layout = KioskLayout.create! valid_attributes
      expect {
        delete :destroy, params: {id: kiosk_layout.to_param}, session: valid_session
      }.to change(KioskLayout, :count).by(-1)
    end

    it "redirects to the kiosk_layouts list" do
      kiosk_layout = KioskLayout.create! valid_attributes
      delete :destroy, params: {id: kiosk_layout.to_param}, session: valid_session
      expect(response).to redirect_to(kiosk_layouts_url)
    end
  end
