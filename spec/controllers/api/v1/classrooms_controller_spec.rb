...
RSpec.describe Api::V1::ClassroomsController, type: :controller do
  ...
  xit 'returns bad_request with missing attributes' do
    get :date, params: { date: '' }
    expect(response).to have_http_status(:internal_server_error)
  end

  xit 'returns bad_request with invalid attributes' do
    get :date, params: { date: 1 }
    expect(response).to have_http_status(:internal_server_error)
  end

  xit 'returns rooms from api classrooms rooms config' do
    get :rooms, params: {}
