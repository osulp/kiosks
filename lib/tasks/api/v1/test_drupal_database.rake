  ...
  task :setup do
    ...
    (1..30).each do |day|
      ...
      Api::V1::DrupalIntersessionHour.create(
        ...
        open_time_wk: Time.new(2000, 0o1, 0o1, 12, 0, 0, '+00:00'),
        close_time_wk: Time.new(2000, 0o1, 0o1, 24, 0, 0, '+00:00'),
        open_time_sat: Time.new(2000, 0o1, 0o1, 12, 0, 0, '+00:00'),
        close_time_sat: Time.new(2000, 0o1, 0o1, 24, 0, 0, '+00:00'),
        open_time_sun: Time.new(2000, 0o1, 0o1, 12, 0, 0, '+00:00'),
        close_time_sun: Time.new(2000, 0o1, 0o1, 24, 0, 0, '+00:00')
      )
    end
    ...
    Api::V1::DrupalSpecialHour.create(
      ...
      open_time: Time.new(2000, 0o1, 0o1, 6, 0, 0, '+00:00'),
      close_time: Time.new(2000, 0o1, 0o1, 18, 0, 0, '+00:00')
    )
